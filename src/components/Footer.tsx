        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="mt-4 space-y-2">
              <li><NavLink to="/" className="text-gray-400 hover:text-[var(--gold)] transition-colors duration-300 text-lg">{t('nav.home')}</NavLink></li>
              <li><NavLink to="/about" className="text-gray-400 hover:text-[var(--gold)] transition-colors duration-300 text-lg">{t('nav.about')}</NavLink></li>
              <li><NavLink to="/services" className="text-gray-400 hover:text-[var(--gold)] transition-colors duration-300 text-lg">{t('nav.services')}</NavLink></li>
              <li><NavLink to="/destinations" className="text-gray-400 hover:text-[var(--gold)] transition-colors duration-300 text-lg">{t('nav.destinations')}</NavLink></li>
              <li><NavLink to="/contact" className="text-gray-400 hover:text-[var(--gold)] transition-colors duration-300 text-lg">{t('nav.contact')}</NavLink></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <div className="mt-4 space-y-3 text-gray-400">
                <div className="flex items-center text-lg" dir="ltr">
