      ...
      <div className="py-20 bg-glass">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-5xl">
          ...
          <div className="mt-20 text-center" data-aos="fade-up" data-aos-delay="200">
              <Link
                  to="/contact"
                  className="inline-block bg-gradient-to-r from-[var(--gold)] to-[var(--gold-darker)] text-gray-900 font-bold py-4 px-10 rounded-full text-xl hover:scale-105 transform transition-transform duration-300 shadow-lg shadow-[var(--gold)]/30"
              >
