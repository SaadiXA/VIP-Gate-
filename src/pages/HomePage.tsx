        ...
        <>
            ...
            <div className="relative h-screen flex items-center justify-center text-center text-white overflow-hidden">
                ...
                <div className="relative z-10 p-4">
                    ...
                    <Link
                        to="#welcome"
                        className="mt-8 inline-block bg-gradient-to-r from-[var(--gold)] to-[var(--gold-darker)] text-gray-900 font-bold py-3 px-8 rounded-full text-lg hover:scale-105 transform transition-transform duration-300 shadow-lg shadow-[var(--gold)]/30"
    ...
    return (
        <section className="py-20 bg-glass border-y border-gray-800/50">
            <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center" data-aos="fade-up">
                ...
                <div className="mt-8">
                     <Link to="/destinations" className="inline-block bg-gradient-to-r from-[var(--gold)] to-[var(--gold-darker)] text-gray-900 font-bold py-3 px-8 rounded-full text-lg hover:scale-105 transform transition-transform duration-300 shadow-lg shadow-[var(--gold)]/30">
                        {t('hero.discover')}
                    </Link>
                </div>
            </div>
